...
| `NEXT_PUBLIC_USE_MOCK_DATA`     | `true` = skip Supabase       |
| `NEXT_PUBLIC_HOSPITAL_NAME`     | Displayed in header          |
| `NEXT_PUBLIC_HOSPITAL_TAGLINE`  | Subtitle in header           |
| `NEXT_PUBLIC_HELPDESK_PHONE`    | Help desk phone number       |
